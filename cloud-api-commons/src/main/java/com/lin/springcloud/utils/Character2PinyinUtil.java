...
public class Character2PinyinUtil {
    private static final int[] values = new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    public static String[] strs = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
     ...
     * 汉字转拼音
     */
    public String character2Pinyin(String source)
    {
        String key, value;
